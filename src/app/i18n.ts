...
const IGBO_COPY: AppCopy = {
  ...
  escalationHeading: "Kpọtụrụ nkwado ugbu a",
  escalationBody: "Ọrụ a enweghị ike inye aka n'ihe a n'enweghị ihe egwu. Jiri nọmba mberede ma ọ bụ nkwado mmadụ n'okpuru.",
...
const YORUBA_COPY: AppCopy = {
  ...
  escalationHeading: "Kàn sí ìrànlọ́wọ́ nísinsinyí",
  escalationBody: "Iṣẹ́ yìí kò lè ṣe ìrànlọ́wọ́ lórí èyí láìléwu. Lo nọ́mbà pàjáwírì tàbí ìrànlọ́wọ́ ẹnìyàn ní ìsàlẹ̀.",
...
const HAUSA_COPY: AppCopy = {
  ...
  escalationHeading: "Tuntuɓi tallafi yanzu",
  escalationBody: "Wannan sabis ba zai iya taimakawa lafiya kan wannan ba. Yi amfani da lambar gaggawa ko tallafin ɗan adam a ƙasa.",
